...
<ArrowBackIosNewIcon sx={{color: "#F98506"}}  /> <span className='DefultColor'>MediCare</span>
            ...
            <p>Thank you for joining HomeRent
. We at HomeRent (HomeRent, “Book”, “Reader” It's HomeRent) respect your privacy and want you to understand how we collect, use, and share data about you. This Privacy Policy covers our data collection practices and describes your rights regarding your personal data.

                Unless we link to a different policy or state otherwise, this Privacy Policy applies when you visit or use the HomeRent and CorpU websites, mobile applications, APIs, or related services, including CorpU Open (the “Services”). It also applies to prospective customers of our business and enterprise products.
...
As permitted by applicable law, if you continue to use the Services after the effective date of any change, then your access and/or use will be deemed an acceptance of (and agreement to follow and be bound by) the revised Privacy Policy. The revised Privacy Policy supersedes all previous Privacy Policies.</p>
                            ...
                            <div id='questions' className="Data">
                                ...
                                <p>If you have any questions, concerns, or disputes regarding our Privacy Policy, please feel free to contact our privacy team (including our Data Protection Officer) at HomeRent@gmail.com. You can also send postal mail to us at HomeRent, 	1216 Mirpur 01 Dhaka Bangladesh.</p>
                            </div>
